...
Build out the landing page to look as close to the design documents as possible.
...
- Solution URL: [Github](https://github.com/SteveNoyes/agency-landing-page)
- Live Site URL: [Github live site](https://stevenoyes.github.io/agency-landing-page/)
